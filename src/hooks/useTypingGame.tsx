...
export function useTypingGame() {
    ...
    const stats = useTypingStats(typingState.charIndex, typingState.mistakes, gameTimer.timeLeft, 60);
    ...
    }, [gameLogic, typingState.charIndex, typingState.setMistakes, typingState.setCharIndex, gameTimer.timeLeft, domHelpers.moveBack]);

    const initTyping = useCallback((event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    }, [gameLogic, typingState.charIndex, typingState.isTyping, typingState.setIsTyping, typingState.setCharIndex, typingState.setMistakes, gameTimer.timeLeft, domHelpers.markCorrect, domHelpers.markWrong]);
